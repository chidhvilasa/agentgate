...
> **Public beta.** This package provides the `agentgate` command-line binary. See the
> [main repository README](https://github.com/chidhvilasa/agentgate#readme) for what AgentGate does, the
